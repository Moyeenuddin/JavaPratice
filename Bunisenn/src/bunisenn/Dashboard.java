...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Salse Information");
        ...
        Price.setMinimumSize(new java.awt.Dimension(8, 25));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        model.addRow(new Object[]{Pname.getText(),Quantity.getText(),Price.getText()});
        
        }else{
            Message.setText("Product Name could not be null");
        }
